...
class Test {
    ...
    public static void main(String args[]) {
        PApplet.main(new String[] {"BallDetector" });
    }

}

public class BallDetector extends PApplet {
...
// L'objet GSCapture étend PImage - se comporte comme un conteneur des frames issues de la webcam
    ...
    public void setup(){ // fonction d'initialisation exécutée 1 fois au démarrage
        ...
        cam.play();  // démarre objet GSCapture = la webcam
...
// Code capture GSVideo
        ...
        if (cam.available() == true) { // si une nouvelle frame est disponible sur la webcam
            ...
            opencv.mixerRGBGray(-0.5f, -0.5f , 1.4f); // mixerRGBGray appliqué sur objet IplImage avec paramètres - ici détection couleur orangée
            ...
            opencv.threshold(0.8f, "BINARY"); // seuillage binaire pour éliminer le fond
            ...
            //-- dessin du rectangle autour du tracé de la forme avant sélection --                                        lgiibrary
